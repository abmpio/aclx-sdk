...
const (
	...
	UserService_FindUserIdAndDisplayNameList_FullMethodName = "/proto.UserService/FindUserIdAndDisplayNameList"
)
...
type UserServiceClient interface {
	...
	FindUserIdAndDisplayNameList(ctx context.Context, in *FindUserIdAndDisplayNameListRequest, opts ...grpc.CallOption) (*FindUserIdAndDisplayNameListResponse, error)
}
...
func (c *userServiceClient) FindUserIdAndDisplayNameList(ctx context.Context, in *FindUserIdAndDisplayNameListRequest, opts ...grpc.CallOption) (*FindUserIdAndDisplayNameListResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FindUserIdAndDisplayNameListResponse)
	err := c.cc.Invoke(ctx, UserService_FindUserIdAndDisplayNameList_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	// 查询用户id和displayName组成的列表
	FindUserIdAndDisplayNameList(context.Context, *FindUserIdAndDisplayNameListRequest) (*FindUserIdAndDisplayNameListResponse, error)
...
func (UnimplementedUserServiceServer) FindUserIdAndDisplayNameList(context.Context, *FindUserIdAndDisplayNameListRequest) (*FindUserIdAndDisplayNameListResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindUserIdAndDisplayNameList not implemented")
}
...
func _UserService_FindUserIdAndDisplayNameList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindUserIdAndDisplayNameListRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).FindUserIdAndDisplayNameList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_FindUserIdAndDisplayNameList_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).FindUserIdAndDisplayNameList(ctx, req.(*FindUserIdAndDisplayNameListRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FindUserIdAndDisplayNameList",
			Handler:    _UserService_FindUserIdAndDisplayNameList_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "aclx.proto",
...
const (
	ApplicationService_FindOneApplication_FullMethodName = "/proto.ApplicationService/FindOneApplication"
)
...
type ApplicationServiceClient interface {
	FindOneApplication(ctx context.Context, in *FindOneApplicationRequest, opts ...grpc.CallOption) (*FindOneApplicationResponse, error)
}
...
func (c *applicationServiceClient) FindOneApplication(ctx context.Context, in *FindOneApplicationRequest, opts ...grpc.CallOption) (*FindOneApplicationResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FindOneApplicationResponse)
	err := c.cc.Invoke(ctx, ApplicationService_FindOneApplication_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ApplicationServiceServer interface {
	FindOneApplication(context.Context, *FindOneApplicationRequest) (*FindOneApplicationResponse, error)
...
func (UnimplementedApplicationServiceServer) FindOneApplication(context.Context, *FindOneApplicationRequest) (*FindOneApplicationResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FindOneApplication not implemented")
}
...
func _ApplicationService_FindOneApplication_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FindOneApplicationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ApplicationServiceServer).FindOneApplication(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ApplicationService_FindOneApplication_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApplicationServiceServer).FindOneApplication(ctx, req.(*FindOneApplicationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ApplicationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "proto.ApplicationService",
	HandlerType: (*ApplicationServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "FindOneApplication",
			Handler:    _ApplicationService_FindOneApplication_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "aclx.proto",
