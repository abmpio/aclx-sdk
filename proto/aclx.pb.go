...
var file_aclx_proto_rawDesc = []byte{
	...
	0x49, 0x6e, 0x66, 0x6f, 0x32, 0xc8, 0x04, 0x0a, 0x04, 0x41, 0x63, 0x6c, 0x78, 0x12, 0x50, 0x0a,
...
var file_aclx_proto_msgTypes = make([]protoimpl.MessageInfo, 25)
...
var file_aclx_proto_depIdxs = []int32{
	...
	26, // 5: proto.UserLoginResult.expires:type_name -> google.protobuf.Timestamp
	18, // 6: proto.UserServiceLoginResponse.result:type_name -> proto.UserLoginResult
	26, // 7: proto.UserServiceRefreshTokenResponse.expires:type_name -> google.protobuf.Timestamp
	23, // 8: proto.UserServiceFindByUserIdResponse.userInfo:type_name -> proto.UserInfo
	2,  // 9: proto.Aclx.AclxHealthCheck:input_type -> proto.AclxHealthCheckRequest
	4,  // 10: proto.Aclx.RegistAppAcl:input_type -> proto.RegistAppAclRequest
	6,  // 11: proto.Aclx.RegistAclApiRule:input_type -> proto.RegistAclApiRuleRequest
	8,  // 12: proto.Aclx.RegistAclPermissionRule:input_type -> proto.RegistAclPermissionRuleRequest
	9,  // 13: proto.Aclx.ReloadAppAcl:input_type -> proto.ReloadAppAclRequest
	10, // 14: proto.Aclx.AclxIsApiAllowed:input_type -> proto.AclxIsApiAllowedRequest
	12, // 15: proto.Aclx.AclxCheckLoginPermission:input_type -> proto.AclxCheckLoginPermissionRequest
	15, // 16: proto.RoleService.EnsureRoleExist:input_type -> proto.EnsureRoleExistRequest
	17, // 17: proto.UserService.UserLogin:input_type -> proto.UserServiceLoginRequest
	20, // 18: proto.UserService.UserRefreshToken:input_type -> proto.UserServiceRefreshTokenRequest
	24, // 19: proto.UserService.FindByUserId:input_type -> proto.UserServiceFindByUserIdRequest
	3,  // 20: proto.Aclx.AclxHealthCheck:output_type -> proto.AclxHealthCheckResponse
	27, // 21: proto.Aclx.RegistAppAcl:output_type -> google.protobuf.Empty
	27, // 22: proto.Aclx.RegistAclApiRule:output_type -> google.protobuf.Empty
	27, // 23: proto.Aclx.RegistAclPermissionRule:output_type -> google.protobuf.Empty
	27, // 24: proto.Aclx.ReloadAppAcl:output_type -> google.protobuf.Empty
	11, // 25: proto.Aclx.AclxIsApiAllowed:output_type -> proto.AclxIsApiAllowedResponse
	13, // 26: proto.Aclx.AclxCheckLoginPermission:output_type -> proto.AclxCheckLoginPermissionResponse
	16, // 27: proto.RoleService.EnsureRoleExist:output_type -> proto.EnsureRoleExistResponse
	19, // 28: proto.UserService.UserLogin:output_type -> proto.UserServiceLoginResponse
	21, // 29: proto.UserService.UserRefreshToken:output_type -> proto.UserServiceRefreshTokenResponse
	25, // 30: proto.UserService.FindByUserId:output_type -> proto.UserServiceFindByUserIdResponse
